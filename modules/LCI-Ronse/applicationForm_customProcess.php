...
$URL = $_SESSION[$guid]['absoluteURL'].'/index.php?q=/modules/LCI-Ronse/applicationForm_custom.php';
...
//         }
        $parent2officialName = $parent2firstName.' '.$parent2surname;
...
//         }
        ...
        if ($surname == '' or $firstName == '' or $preferredName == '' or $officialName == '' or $gender == '' or $dob == '' or $languageHomePrimary == '' or $languageFirst == '' or $countryOfBirth == '' or $citizenship1 == '' or $gibbonSchoolYearIDEntry == '' or $gibbonYearGroupIDEntry == '' or (isset($_POST['agreement']) and $agreement != 'Y') or $familyFail) {
            $URL .= '&return=error1';
            //var_dump($surname,$firstName,$preferredName,$officialName,$gender,$dob,$languageHomePrimary,$languageFirst,$countryOfBirth,$citizenship1,(isset($_POST['agreement']) and $agreement != 'Y'),$familyFail);
            //die($URL);
            header("Location: {$URL}");
        } else {
            ...
            if ($customRequireFail) {
                ...
                if ($applicationFee > 0 and is_numeric($applicationFee) and $enablePayments == 'Y' and $paypalAPIUsername != '' and $paypalAPIPassword != '' and $paypalAPISignature != '') {
                    $_SESSION[$guid]['gatewayCurrencyNoSupportReturnURL'] = $_SESSION[$guid]['absoluteURL']."/index.php?q=/modules/LCI-Ronse/applicationForm_custom.php&return=success4&id=$secureAI";
                    $URL = $_SESSION[$guid]['absoluteURL']."/lib/paypal/expresscheckout.php?Payment_Amount=$applicationFee&return=".urlencode("modules/LCI-Ronse/applicationForm_customProcess.php?return=success1&id=$secureAI&applicationFee=$applicationFee").'&fail='.urlencode("modules/LCI-Ronse/applicationForm_customProcess.php?return=success2&id=$secureAI&applicationFee=$applicationFee");
                    header("Location: {$URL}");
                } else {
