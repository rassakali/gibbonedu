...
if (isActionAccessible($guid, $connection2, '/modules/Finance/custom_invoices_manage.php') == false) {
    //Acess denied
    ...
    //Proceed!
    $page->breadcrumbs->add(__('Manage Recurring Invoices'));
    ...
    if ($gibbonSchoolYearID != '') {
        ...
        echo "<div class='linkTop'>";
            ...
            if (getPreviousSchoolYearID($gibbonSchoolYearID, $connection2) != false) {
                echo "<a href='".$_SESSION[$guid]['absoluteURL'].'/index.php?q=/modules/'.$_SESSION[$guid]['module'].'/custom_invoices_manage.php&gibbonSchoolYearID='.getPreviousSchoolYearID($gibbonSchoolYearID, $connection2)."'>".__('Previous Year').'</a> ';
            } else {
                echo __('Previous Year').' ';
            }
        echo ' | ';
        if (getNextSchoolYearID($gibbonSchoolYearID, $connection2) != false) {
            echo "<a href='".$_SESSION[$guid]['absoluteURL'].'/index.php?q=/modules/'.$_SESSION[$guid]['module'].'/custom_invoices_manage.php&gibbonSchoolYearID='.getNextSchoolYearID($gibbonSchoolYearID, $connection2)."'>".__('Next Year').'</a> ';
        } else {
            echo __('Next Year').' ';
        }
        echo '</div>';
        ...
        $form->addHiddenValue('q', '/modules/Finance/custom_invoices_manage.php');
        ...
        $table->addHeaderAction('add', __('Add'))
            ->setURL('/modules/Finance/custom_invoices_manage_add.php')
            ...
            ->format(function ($invoice, $actions) {
                if ($invoice['status'] != 'Cancelled' && $invoice['status'] != 'Refunded') {
                    $actions->addAction('edit', __('Edit'))
                        ->setURL('/modules/Finance/custom_invoices_manage_edit.php');
                }
