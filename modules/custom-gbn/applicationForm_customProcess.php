...
$URL = $_SESSION[$guid]['absoluteURL'].'/index.php?q=/modules/custom-gbn/applicationForm_custom.php';
...
if (isset($_SESSION[$guid]['username']) == false) {
    ...
    if (isActionAccessible($guid, $connection2, '/modules/custom-gbn/applicationForm_custom.php') != false) {
        $proceed = true;
    }
}
        ...
        if ($surname == '' or $firstName == '' or $preferredName == '' or $officialName == '' or $gender == '' or $dob == '' or $languageHomePrimary == '' or $languageFirst == '' or $countryOfBirth == '' or $citizenship1 == '' or $gibbonSchoolYearIDEntry == '' or $gibbonYearGroupIDEntry == '' or (isset($_POST['agreement']) and $agreement != 'Y') or $familyFail) {
            ...
            if ($customRequireFail) {
                ...
                if ($applicationFee > 0 and is_numeric($applicationFee) and $enablePayments == 'Y' and $paypalAPIUsername != '' and $paypalAPIPassword != '' and $paypalAPISignature != '') {
                    $_SESSION[$guid]['gatewayCurrencyNoSupportReturnURL'] = $_SESSION[$guid]['absoluteURL']."/index.php?q=/modules/custom-gbn/applicationForm_custom.php&return=success4&id=$secureAI";
                    $URL = $_SESSION[$guid]['absoluteURL']."/lib/paypal/expresscheckout.php?Payment_Amount=$applicationFee&return=".urlencode("modules/custom-gbn/applicationForm_customProcess.php?return=success1&id=$secureAI&applicationFee=$applicationFee").'&fail='.urlencode("modules/custom-gbn/applicationForm_customProcess.php?return=success2&id=$secureAI&applicationFee=$applicationFee");
                    header("Location: {$URL}");
                } else {
